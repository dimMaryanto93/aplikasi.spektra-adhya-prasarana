...
public class AngsuranPrestasiPersetujuanFormController implements BootFormInitializable {
	...
	@FXML
	private TextField txtTypeMotor;
	@FXML
	private TextField txtWarnaMotor;
	@FXML
	...
	private void setFields(DataKaryawan karyawan) {
		...
		txtTypeMotor.setText(motor.getTypeMotor());
		txtWarnaMotor.setText(motor.getWarnaMotor());
		txtDealer.setText(motor.getDealer());
	}
