...
import app.controller.peminjaman.DaftarPeminjamanKaryawan;
...
public class HomeController implements BootInitializable {
	...
	@Autowired
	private KasbonKaryawanListController listKasbonPerKaryawan;
	@Autowired
	private DaftarPeminjamanKaryawan listKasbonKaryawan;
	@Autowired
	...
	@FXML
	MenuItem mniLaporanKasbonPerKaryawan;
	...
	public void setMniLaporanKasbonPerKaryawan(Boolean disable) {
		this.mniLaporanKasbonPerKaryawan.setDisable(disable);
	}
	...
	public void showDaftarKasbonKaryawan(ActionEvent event) {
		try {
			setLayout(listKasbonKaryawan.initView());
			listKasbonKaryawan.initConstuct();

			this.setTitleContent("Daftar data kasbon");
		} catch (IOException e) {
	...
	@FXML
	public void showDaftarKasbonKaryawanPerKaryawan(ActionEvent event) {
		try {
			setLayout(listKasbonPerKaryawan.initView());
			listKasbonPerKaryawan.initConstuct();
